...
class CommunityDetailImg3Fragment(private val image: String) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_community_detail_img3, container, false)

        val detailImage3 = rootView.findViewById<ImageView>(R.id.detailImage3)
