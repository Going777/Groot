...
for row in reader:
    ...
    if (response.status_code == 200):
        ...
        # code
        # data = [id, name, soup.find('plntzrnm').text, soup.find('plntbnenm').text,
        #     soup.find('adviseinfo').text, soup.find('growthhginfo').text, soup.find('growtharainfo').text,
        #     soup.find('smellcode').text, soup.find('toxctyinfo').text, soup.find('managelevelcode').text,
        #     soup.find('grwtvecode').text, soup.find('grwhtpcode').text, soup.find('hdcode').text,
        #     soup.find('watercyclesprngcode').text, soup.find('watercyclewintercode').text,
        #     soup.find('speclmanageinfo').text, soup.find('fncltyinfo').text,
        #     soup.find('managedemanddocode').text, soup.find('lefmrkcodenm').text,
        #     soup.find('lefcolrcodenm').text, soup.find('lighttdemanddocodenm').text
        #     soup.find('postngplacecodenm').text, soup.find('dlthtscodenm').text, soup.find('grwhstlecode').text
        #     soup.find('winterlwettpcode').text]
